-- Step 2 of 2: HSQ helpers, tables, and RLS.
-- Run AFTER 0007_team_leader_hsq.sql has succeeded (enum value must already be committed).
...
drop policy if exists hsq_report_workers_manage on public.hsq_report_workers;
